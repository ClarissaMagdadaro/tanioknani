        ...
        <section class="dashboard">
            ...
            <div class="box-container">
                ...
                <div class="box">
                    ...
                    <a href="../admin_panel/admin_order.php" class="btn">Total Orders</a>
                </div>
                <div class="box">
                    <?php
                    ...
                    <a href="../admin_panel/admin_order.php" class="btn">Confirm Orders</a>
                </div>
                <div class="box">
                    <?php
                    ...
                    <a href="../admin_panel/admin_order.php" class="btn">Cancel Orders</a>
                </div>
            </div>
        </section>
    </div>
