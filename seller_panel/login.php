...
if (isset($_POST['submit'])) {
    ...
    // Prepare SQL query to check if seller exists
    ...
    if ($select_seller->rowCount() > 0) {
        // Set a cookie for the seller_id if the login is successful
        setcookie('seller_id', $row['id'], time() + (86400 * 30), '/'); // 30 days expiration
        
        // Redirect to the seller dashboard
        header('Location: ../seller_panel/dashboard.php');
        exit();
    } else {
...
<html>
    <head>
        ...
        <title>Figuras D Arte - Seller Login</title>
